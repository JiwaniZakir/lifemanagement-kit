...
description: A comprehensive guide to understanding the OpenClaw platform and how Aegis extends it, including installation, configuration, skills, hooks, and adding Aegis features to any OpenClaw installation.
---
