"""Add Spotify listening history tables.
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("popularity", sa.Integer(), nullable=False, default=0),
    ...
    op.create_index("ix_listening_history_user_ts", "listening_history", ["user_id", "played_at_ts"])
    ...
    # Create indexes for spotify_top_snapshot
    op.create_index("ix_spotify_top_snapshot_user_id", "spotify_top_snapshot", ["user_id"])
    op.create_index(
